create database khome character set utf8;
#创建文章表
CREATE TABLE `khome`.`ARTICLE` (
...
ENGINE = INNODB
COMMENT = '图片内容';
ALTER TABLE `khome`.`BRIEF_PIC` 
DROP COLUMN `PIC_TITLE`;

#创建信息记录表
CREATE TABLE `khome`.`MESSAGE` (
